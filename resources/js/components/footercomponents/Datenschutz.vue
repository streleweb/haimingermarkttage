    ...
    >
      ...
      >
        ...
        >
          ...
          "www.haiminger-markttage.at/app" informieren. <br /><br />
          ...
          oder “Verarbeitung”) finden Sie in Art. 4 DSGVO. <br /><br />

          <div class="text-lg md:text-3xl">Automatische Datenspeicherung</div>
          <br />
          ...
          automatisch folgende Daten in Webserver-Logfiles: <br /><br />

          <ul style="list-style-type: circle" class="pl-6">
          ...
          rechtswidrigem Verhalten eingesehen werden. <br /><br />

          <div class="text-lg md:text-3xl">Speicherung persönlicher Daten</div>
          <br />
          ...
          www.haiminger-markttage.at, auf welcher folgendes gilt: <br /><br />
          ...
          <br />Ihnen stehen laut den Bestimmungen der DSGVO und des
          ...
          <div class="text-lg md:text-3xl">TLS-Verschlüsselung mit HTTPS</div>
          <br />
          ...
          <div class="text-lg md:text-3xl">Cookies</div>
          <br />Unsere Webseite verwendet HTTP-Cookies, um nutzerspezifische
          ...
          <div class="text-lg md:text-3xl">Was sind Cookies?</div>
          <br />
          ...
          <div class="text-lg md:text-3xl">Wie kann ich Cookies löschen?</div>
          <br />
          ...
          <div class="text-lg md:text-3xl">Was sind Google-Fonts?</div>
          <br />
