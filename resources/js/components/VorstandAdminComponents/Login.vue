<template>
  <div class="
    ...
    <div class="
      ...
      <div class="text-red-500 text-center content-center" v-if="error" id="fehler">
        {{ error }}
      </div>
      <div>
        <img class="mx-auto h-20 w-auto border border-green-500" src="/images/icons/pngs/icon-512x512.png"
          alt="Workflow" />
