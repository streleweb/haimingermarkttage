...
export default {
  data() {
    return {
      aussteller: [],
      smallDescription:
        "Hier finden Sie alle Aussteller zur Sparte Textil. Nähere Informationen befinden sich in der jeweiligen Ausstellerbeschreibung. Klicken Sie auf die jeweilige Aussteller-Farbzone, um die Farbzonen auf einer Karte einzusehen.",
      loading: false,
    };
  },
  ...
  methods: {
    loadAussteller() {
      axios
        .get("/api/getAllAusstellerOfSpecificProduktreiter/Textil")
        .then((response) => {
